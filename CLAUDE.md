...
**B12 — QA y Lanzamiento: 🔄 EN CURSO** — ✅ higiene de secretos (Resend rotada, obsoletos borrados, `.env` fuera de git — 2 jul); ✅ revisión RLS (sólida; hardening aplicado 2 jul); ✅ pen test de endpoints (HMAC + x-api-key + JWT sin agujeros, 2 jul; falta solo aislamiento cruzado CV↔CV con datos reales); ⬜ pendiente: monitoring
