...
| Nueva solicitud de visita | CV | **Tienes una nueva solicitud de visita** | "un comprador ha solicitado una visita a tu vivienda" + vivienda, fecha/hora y visitante + "Accede a tu área privada para confirmar la visita." + botón a la app |
