// Iconos de trazo (estilo Lucide) — DESIGN.md v3.0: stroke 1.5px, linecap/linejoin
// redondeados, sin relleno. El color se hereda del contexto vía currentColor.
...
function Svg({ size = 20, className, strokeWidth = 1.5, children }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconEuro(p: IconProps) {
  return <Svg {...p}><path d="M19 5.5A9 9 0 0 0 5.3 7M19 18.5A9 9 0 0 1 5.3 17" /><path d="M3 10h10M3 14h8" /></Svg>
}
